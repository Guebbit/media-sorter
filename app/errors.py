...
`MediaSortError` is a bug, and is meant to reach a traceback.
"""

from __future__ import annotations


class MediaSortError(Exception):
    """Base class for every expected, reportable failure."""


class ConfigError(MediaSortError, ValueError):
    """A setting is missing or nonsensical."""


class RuleError(MediaSortError, ValueError):
